...
class MapHelper {
  ...
  static Future<BitmapDescriptor> _getClusterMarker(int clusterSize,
      Color clusterColor,
      Color textColor,
      int width,) async {
  ...
  static Future<Uint8List> _resizeImageBytes(Uint8List imageBytes,
  ...
  static Future<List<Marker>> getClusterMarkers(
    ...
    Future<List<Marker>> dd = Future.wait(clusterManager.clusters(
