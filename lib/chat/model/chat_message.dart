  ...
  Widget build(BuildContext context) {
    return SizeTransition(
        ...
        child: Container(
          ...
          child: Row(
            crossAxisAlignment: (UID_FOR_CHAT != sender_id_
  ...
  Widget returnChatBody(String m_type, String s_id, String m_body) {
    ...
    if (m_type == "TYPE_TEXT") {
        ...
        return Card(
            ...
            child: Container(
              ...
              child: Padding(
                padding: EdgeInsets.all(10),
                child:
                    Text(message_body_, style: TextStyle(color: Colors.white)),
              ),
            ));
      }
      ...
      if (UID_FOR_CHAT == s_id) {
        return Container(
          height: 300,
          margin: EdgeInsets.fromLTRB(60, 00, 00, 0),
          child: Image.network(message_body_),
        );
      } else {
        return Container(
          height: 300,
          margin: EdgeInsets.fromLTRB(00, 00, 60, 0),
          child: Image.network(message_body_),
        );
      }
